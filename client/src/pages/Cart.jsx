...
const Cart = () => {
    ...
    console.log("Cart Component - Addresses:", addresses);
    console.log("Cart Component - Selected Address:", selectedAddress);
    ...
    const handleQuantityChange=(e)=>{
        ...
        e.preventDefault();
        updateCartItem(products._id,Number(e.target.value))
    }
    ...
    return products.length>0 && cartItems ? (
        <div className="flex flex-col md:flex-row mt-16">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                            ...
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full z-10">
                                {addresses.map((address, index) => (
                                    <div key={index} 
                                         ...
                                         className="text-gray-500 p-2 hover:bg-gray-100 cursor-pointer border-b last:border-b-0">
                                        <p className="font-medium">{address.firstName} {address.lastName}</p>
                                        <p className="text-xs">{address.street}, {address.city}, {address.state}, {address.country} - {address.zipcode}</p>
                ...
                <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer bg-primary text-white font-medium hover:bg-primary-600 transition">
