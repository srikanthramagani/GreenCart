  ...
  return (
    ...
    <div className="md:p-10 p-4 space-y-4">
            ...
            {orders.map((order, index) => (
                <div key={index} className="flex flex-col md:items-center md:flex-row gap-5 justify-between md:items-center gap-5 p-5 max-w-4xl rounded-md border border-gray-300 ">
